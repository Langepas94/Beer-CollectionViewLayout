...
class ErrorMainScreen: UIView {
    ...
    private let bannerImageView: UIImageView = {
        ...
        banner.image = UIImage(systemName: "figure.volleyball")?.withRenderingMode(.alwaysOriginal).withTintColor(.black)
    ...
    private let labelView: UILabel = {
        ...
        label.text = "No internet connection awailable, maybe time to sport?"
